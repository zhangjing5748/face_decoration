...
module.exports = (function () {
  ...
  Object.assign(THREE.FBXLoader.prototype, {
    ...
    downloadAndParse: function (url, onLoad, onProgress, onError) {
      var self = this;
      ...
      loader.load(url, (buffer) => {
        let FBXTree = self.parseOne(buffer, url)
        onLoad(FBXTree)
      }, onProgress, onError)
    },
    loadSub: function (FBXTree, url, onLoad, onError) {
      ...
      try {
        ...
        var scene = self.parseTwo(FBXTree, resourceDirectory);
        onLoad(scene);
    ...
    parseOne: function (FBXBuffer, url) {
      // console.time('parseOne')
      let FBXTree;
      // var resourceDirectory = THREE.LoaderUtils.extractUrlBase(url);
    ...
    parseTwo: function ({
      ...
      // parseTwo: function (sceneGraph) {
      // console.log( FBXTree );
      // console.time('parseTwo')
      // console.time('image')
      var images = parseImages(FBXTree);
      ...
      // console.time('deformers')
      var deformers = parseDeformers(FBXTree, connections);
      // console.timeEnd('deformers')
      // console.time('geometryMap')
      var geometryMap = parseGeometries(FBXTree, connections, deformers);
      // console.timeEnd('geometryMap')
      // console.time('sceneGraph')
      var sceneGraph = parseScene(FBXTree, connections, deformers.skeletons, geometryMap, materials);
      // console.timeEnd('sceneGraph')
      // console.timeEnd('parseTwo')
      return sceneGraph;
